package com.projectspring.course.resources.exceptions;
...
public class ResourceExceptionHandler {
    ...
    public ResponseEntity<StandardError> databaseBadRequest(DatabaseExcpetion e, HttpServletRequest request) {
